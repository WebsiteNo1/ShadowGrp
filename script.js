...
const links = {
    1: { url: 'https://chat.whatsapp.com/HfhVr7UcRjXKHDAjL26Stn?mode=hqrc', text: 'Join SHADOW LIMITED 6V6' },
    2: { url: 'https://chat.whatsapp.com/L6YfLaGjV87K4KAghZk8wZ?mode=hqrc', text: 'Join SHADOW UNLIMITED 6V6' },
    3: { url: 'https://chat.whatsapp.com/0029Vb7QSQr6xCSTDf0ul1L', text: 'Community' }
};
